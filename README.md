...
适用于 [Orca Notes](https://orca.sh/) 的 Tokyo Night 双模主题，支持 Light / Dark 自动切换，并对编辑区、侧边栏、设置页和白板场景做了系统化视觉统一。
...
## <img src="https://unpkg.com/lucide-static@latest/icons/palette.svg" alt="Palette" width="16" height="16"> 特色样式
...
## <img src="https://unpkg.com/lucide-static@latest/icons/download.svg" alt="Download" width="16" height="16"> 安装
...
## <img src="https://unpkg.com/lucide-static@latest/icons/wrench.svg" alt="Wrench" width="16" height="16"> 开发与构建
...
## <img src="https://unpkg.com/lucide-static@latest/icons/heart-handshake.svg" alt="Heart Handshake" width="16" height="16"> 致谢
...
## <img src="https://unpkg.com/lucide-static@latest/icons/scale.svg" alt="Scale" width="16" height="16"> 许可证
